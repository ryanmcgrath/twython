...
class setup:
	...
	def getUserTimeline(self, id = None, version = None, **kwargs): 
		...
		if id is not None and ("user_id" in kwargs) is False and ("screen_name" in kwargs) is False:
			userTimelineURL = self.constructApiURL("http://api.twitter.com/%d/statuses/user_timeline/%s.json" % (version, repr(id)), kwargs)
			...
			if id is not None or user_id is not None or screen_name is not None:
				try:
					...
					if user_id is not None:
						apiExtension = "user_id=%s" % repr(user_id)
					...
					raise TwythonError("reportSpam() failed with a %s error code." % repr(e.code), e.code)
			else:
	...
	def reTweet(self, id, version = None):
		...
		if self.authenticated is True:
			try:
				return simplejson.load(self.opener.open("http://api.twitter.com/%d/statuses/retweet/%s.json" % (version, repr(id)), "POST"))
			except HTTPError as e:
	...
	def getRetweets(self, id, count = None, version = None):
		...
		version = version or self.apiVersion
		if self.authenticated is True:
			apiURL = "http://api.twitter.com/%d/statuses/retweets/%s.json" % (version, repr(id))
	...
	def showUser(self, id = None, user_id = None, screen_name = None, version = None):
		...
		if user_id is not None:
			apiURL = "http://api.twitter.com/%d/users/show.json?user_id=%s" % (version, repr(user_id))
		if screen_name is not None:
	...
	def getFriendsStatus(self, id = None, user_id = None, screen_name = None, page = None, cursor="-1", version = None):
		...
		if self.authenticated is True:
			...
			if user_id is not None:
				apiURL = "http://api.twitter.com/%d/statuses/friends.json?user_id=%s" % (version, repr(user_id))
			if screen_name is not None:
	...
	def getFollowersStatus(self, id = None, user_id = None, screen_name = None, page = None, cursor = "-1", version = None):
		...
		if self.authenticated is True:
			...
			if user_id is not None:
				apiURL = "http://api.twitter.com/%d/statuses/followers.json?user_id=%s" % (version, repr(user_id))
			if screen_name is not None:
	...
	def getDirectMessages(self, since_id = None, max_id = None, count = None, page = "1", version = None):
		...
		version = version or self.apiVersion
		if self.authenticated is True:
			apiURL = "http://api.twitter.com/%d/direct_messages.json?page=%s" % (version, repr(page))
	...
	def getSentMessages(self, since_id = None, max_id = None, count = None, page = "1", version = None):
		...
		version = version or self.apiVersion
		if self.authenticated is True:
			apiURL = "http://api.twitter.com/%d/direct_messages/sent.json?page=%s" % (version, repr(page))
			if since_id is not None:
				apiURL += "&since_id=%s" % repr(since_id)
			if max_id is not None:
				apiURL += "&max_id=%s" % repr(max_id)
	...
	def sendDirectMessage(self, user, text, version = None):
		...
		if self.authenticated is True:
			if len(list(text)) < 140:
				try:
					return self.opener.open("http://api.twitter.com/%d/direct_messages/new.json" % version, urllib.parse.urlencode({"user": user, "text": text}))
				except HTTPError as e:
	...
	def checkIfFriendshipExists(self, user_a, user_b, version = None):
		...
		if self.authenticated is True:
			try:
				friendshipURL = "http://api.twitter.com/%d/friendships/exists.json?%s" % (version, urllib.parse.urlencode({"user_a": user_a, "user_b": user_b}))
	...
	def showFriendship(self, source_id = None, source_screen_name = None, target_id = None, target_screen_name = None, version = None):
		...
		try:
			...
			raise TwythonError("showFriendship() failed with a %s error code." % repr(e.code), e.code)
	...
	def updateDeliveryDevice(self, device_name = "none", version = None):
		...
		if self.authenticated is True:
			try:
				return self.opener.open("http://api.twitter.com/%d/account/update_delivery_device.json?" % version, urllib.parse.urlencode({"device": self.unicode2utf8(device_name)}))
			except HTTPError as e:
	...
	def getFavorites(self, page = "1", version = None):
		...
		if self.authenticated is True:
			try:
				return simplejson.load(self.opener.open("http://api.twitter.com/%d/favorites.json?page=%s" % (version, repr(page))))
			except HTTPError as e:
	...
	def createFavorite(self, id, version = None):
		...
		if self.authenticated is True:
			try:
				return simplejson.load(self.opener.open("http://api.twitter.com/%d/favorites/create/%s.json" % (version, repr(id)), ""))
			except HTTPError as e:
	...
	def destroyFavorite(self, id, version = None):
		...
		if self.authenticated is True:
			try:
				return simplejson.load(self.opener.open("http://api.twitter.com/%d/favorites/destroy/%s.json" % (version, repr(id)), ""))
			except HTTPError as e:
	...
	def notificationFollow(self, id = None, user_id = None, screen_name = None, version = None):
		...
		if self.authenticated is True:
			...
			if user_id is not None:
				apiURL = "http://api.twitter.com/%d/notifications/follow/follow.json?user_id=%s" % (version, repr(user_id))
			if screen_name is not None:
	...
	def notificationLeave(self, id = None, user_id = None, screen_name = None, version = None):
		...
		if self.authenticated is True:
			...
			if user_id is not None:
				apiURL = "http://api.twitter.com/%d/notifications/leave/leave.json?user_id=%s" % (version, repr(user_id))
			if screen_name is not None:
	...
	def getFriendsIDs(self, id = None, user_id = None, screen_name = None, page = None, cursor = "-1", version = None):
		...
		if user_id is not None:
			apiURL = "http://api.twitter.com/%d/friends/ids.json?user_id=%s&%s" %(version, repr(user_id), breakResults)
		if screen_name is not None:
	...
	def getFollowersIDs(self, id = None, user_id = None, screen_name = None, page = None, cursor = "-1", version = None):
		...
		if page is not None:
			breakResults = "page=%s" % page
		if id is not None:
			apiURL = "http://api.twitter.com/%d/followers/ids/%s.json?%s" % (version, repr(id), breakResults)
		if user_id is not None:
			apiURL = "http://api.twitter.com/%d/followers/ids.json?user_id=%s&%s" %(version, repr(user_id), breakResults)
		if screen_name is not None:
	...
	def createBlock(self, id, version = None):
		...
		if self.authenticated is True:
			try:
				return simplejson.load(self.opener.open("http://api.twitter.com/%d/blocks/create/%s.json" % (version, repr(id)), ""))
			except HTTPError as e:
	...
	def destroyBlock(self, id, version = None):
		...
		if self.authenticated is True:
			try:
				return simplejson.load(self.opener.open("http://api.twitter.com/%d/blocks/destroy/%s.json" % (version, repr(id)), ""))
			except HTTPError as e:
	...
	def checkIfBlockExists(self, id = None, user_id = None, screen_name = None, version = None):
		...
		apiURL = ""
		if id is not None:
			apiURL = "http://api.twitter.com/%d/blocks/exists/%s.json" % (version, repr(id))
		if user_id is not None:
			apiURL = "http://api.twitter.com/%d/blocks/exists.json?user_id=%s" % (version, repr(user_id))
		if screen_name is not None:
	...
	def getBlocking(self, page = "1", version = None):
		...
		if self.authenticated is True:
			try:
				return simplejson.load(self.opener.open("http://api.twitter.com/%d/blocks/blocking.json?page=%s" % (version, repr(page))))
			except HTTPError as e:
	...
	def showSavedSearch(self, id, version = None):
		...
		if self.authenticated is True:
			try:
				return simplejson.load(self.opener.open("http://api.twitter.com/%d/saved_searches/show/%s.json" % (version, repr(id))))
			except HTTPError as e:
	...
	def destroySavedSearch(self, id, version = None):
		...
		if self.authenticated is True:
			try:
				return simplejson.load(self.opener.open("http://api.twitter.com/%d/saved_searches/destroy/%s.json" % (version, repr(id)), ""))
			except HTTPError as e:
